  ...
  return (
    <PageShell>
      <Card>
        ...
        <ol className="text-instructions mt-6 flex flex-col gap-3 text-ink-soft">
        ...
        <p className="text-supporting mt-5 text-ink-soft">{SPEAKING_NOTE}</p>
        <p className="text-supporting mt-1 text-ink-soft">
          {SCORING_MODEL_DISCLAIMER}
        </p>
        <Button className="mt-8" onClick={handleBegin}>
          Begin Listening
        </Button>
      </Card>
    </PageShell>
